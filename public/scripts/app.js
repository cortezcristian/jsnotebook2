...
angular
  ...
  .config(function ($routeProvider, $locationProvider, RestangularProvider,
    uiSelectConfig, hotkeysProvider, AngularSpotlightProvider, NotebookStorageServProvider) {
    ...
    searchOnJSNotebook();
    function searchOnJSNotebook() {
      // AngularSpotlightProvider.search = function ($q, NotebookStorageServ) {
      AngularSpotlightProvider.search = function ($http, $q) {
        return function (term) {
          var defer = $q.defer();
          console.log(term);
          // var res = NotebookStorageServ.search(term);
